...
def abcd():
    ...
    return render_template("templates/index.html" , origin = source, destination = dest, temps = temparr,places = tempplace, coordarr = redcoord, check = check, serverjson = sjson)
...
def abcd_abc():
    ...
    return render_template("templates/index.html",origin = source, destination = dest, temps = temparr,places = tempplace, coordarr = redcoord, check = check, serverjson = dir_json, cost = cost  )
